...
export const create = async (req, res) => {
    ...
    const ride_endpoint = config.services.ride
    const rideRes = await axios.get(`${ride_endpoint}/${rideId}`)
    ...
    const driver_endpoint = config.services.driver
    console.log(`3. Calling DRIVER Service to reset driver ${ride.driverId} status to AVAILABLE.`)
    await axios.put(`${driver_endpoint}/${ride.driverId}`, driverUpdatePayload)
